...
export default async function HistoryPage() {
  ...
  return (
    <main style={{ display: 'grid', gap: 20 }}>
      ...
      {userRole === 'owner' ? (
        <div>
          <Link href="/dashboard/history/export" style={{ display: 'inline-block', padding: '10px 14px', borderRadius: 10, border: '1px solid #d1d5db', textDecoration: 'none', color: '#111827', background: '#fff' }}>
            Export CSV
          </Link>
        </div>
      ) : null}
