  ...
  return (
    <section style={{ border: '1px solid var(--border)', borderRadius: 12, padding: 16, background: 'var(--surface)', display: 'grid', gap: 12 }}>
      ...
      <div style={{ display: 'grid', gap: 12, gridTemplateColumns: 'repeat(auto-fit, minmax(220px, 1fr))' }}>
        <label>
          <div>Bike</div>
          <select id="incidentBikeId" style={{ width: '100%', padding: 10, marginTop: 4, border: '1px solid var(--border-strong)', borderRadius: 10 }}>
        ...
        <label>
          <div>Severity</div>
          <input id="incidentSeverity" type="text" placeholder="e.g. low, medium, high" style={{ width: '100%', padding: 10, marginTop: 4, border: '1px solid var(--border-strong)', borderRadius: 10 }} />
        </label>
      </div>

      <label>
        <div>Description</div>
        <textarea id="incidentDescription" placeholder="Describe what happened" style={{ width: '100%', minHeight: 120, padding: 10, marginTop: 4, border: '1px solid var(--border-strong)', borderRadius: 10 }} />
      </label>
