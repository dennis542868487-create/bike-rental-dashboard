    ...
    <section style={{ border: '1px solid var(--border)', borderRadius: 12, padding: 16, background: 'var(--surface)', display: 'grid', gap: 12 }}>
      ...
      <div style={{ display: 'grid', gap: 12, gridTemplateColumns: 'repeat(auto-fit, minmax(180px, 1fr))' }}>
        <label>
          ...
          <input id="adultBikeQuantity" type="number" min="0" defaultValue="0" style={{ width: '100%', padding: 10, marginTop: 4, border: '1px solid var(--border-strong)', borderRadius: 10 }} />
        </label>
        <label>
          <div>Kid Bike Quantity</div>
          <input id="kidBikeQuantity" type="number" min="0" defaultValue="0" style={{ width: '100%', padding: 10, marginTop: 4, border: '1px solid var(--border-strong)', borderRadius: 10 }} />
        </label>
        <label>
          <div>Trailer Quantity</div>
          <input id="trailerQuantity" type="number" min="0" defaultValue="0" style={{ width: '100%', padding: 10, marginTop: 4, border: '1px solid var(--border-strong)', borderRadius: 10 }} />
        </label>
      </div>

      <div style={{ display: 'grid', gap: 12, gridTemplateColumns: 'repeat(auto-fit, minmax(220px, 1fr))' }}>
        <div>
          <div style={{ fontSize: 14, color: 'var(--text-muted)' }}>Customer Submitted At</div>
          <div style={{ padding: '10px 0', fontSize: 14 }}>{submittedAt}</div>
        </div>
        <label>
          <div>Start Time</div>
          <input id="startTime" type="datetime-local" style={{ width: '100%', padding: 10, marginTop: 4, border: '1px solid var(--border-strong)', borderRadius: 10 }} />
        </label>
      </div>

      <label>
        <div>Assign Bikes</div>
        <select id="bikeIds" multiple style={{ width: '100%', minHeight: 140, padding: 10, marginTop: 4, border: '1px solid var(--border-strong)', borderRadius: 10 }}>
      ...
      <label>
        <div>Staff Notes</div>
        <textarea id="staffNotes" placeholder="Optional notes for this rental" style={{ width: '100%', minHeight: 100, padding: 10, marginTop: 4, border: '1px solid var(--border-strong)', borderRadius: 10 }} />
      </label>
      ...
      <div style={{ display: 'flex', gap: 12, flexWrap: 'wrap' }}>
        ...
        <button
          ...
          disabled={isPending}
          style={{ padding: 14, borderRadius: 12, border: '1px solid var(--border-strong)', background: 'var(--surface)', color: 'var(--text-primary)', maxWidth: 220 }}
        >
